...
export const Illuminator: React.FC<{
  ...
  const lookat = useRef<typeof Sphere>(null);
  ...
  return (
    <>
      ...
      <group ref={ref} onClick={fixIlluminator}>
        {/* @ts-ignore */}
        {lookat.current && <spotLight target={lookat.current} angle={Math.PI / 4} distance={1000} intensity={2} color={color} castShadow shadow-radius={20} shadow-mapSize={[2048, 2048]} />}
        {/* @ts-ignore */}
        <Sphere args={[5, 32]}>
